...
class LoadConfigTest(unittest.TestCase):
  ...
  def test_dry_run_does_not_write_to_dconf(self):
    ...
    self._load_config([
        {'key': 'foo', 'reset': True},
        {'key': 'bar', 'value': '42'},
        {'dir': 'some-dir', 'children': [{'key': 'foo', 'reset': True}]},
    ], dry_run=True)
    actual_write_calls = [
...
class MainTest(unittest.TestCase):
  ...
  def test_ignore_unknown_file(self):
    ...
    # TODO: Use assert_not_called in py>=3.6.
    # Despite the docs saying that assert_not_called is in 3.5, see
    # https://bugs.python.org/issue28380
    self.assertEqual(0, len(self._run.mock_calls))
