...
class PythonMetaPlugin(MetaPlugin):
  ...
  def __init__(self, filename):
    ...
    # The exec_module call below might not strictly follow the importlib
    # documentation, but it seems to work. See
    # https://github.com/google/pytype/issues/319 for context.
    # TODO: Figure out the right way to load a python file by filename.
...
class SnippetPlugin(Plugin):
  ...
  def is_applicable(self, snipphthalate_context: context.Context, tag: str,
...
class Jinja2SnippetPlugin(SnippetPlugin):
  ...
  def update_context(self, jinja2_context: Dict[str, Any],
