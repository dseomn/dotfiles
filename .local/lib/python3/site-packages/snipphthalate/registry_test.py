...
class _TestSnippetPlugin(plugin.Jinja2SnippetPlugin):
  ...
  def __init__(self, variants=None, jinja2_context=None):
    """Initializer.
...
class RegistryTest(unittest.TestCase):
  ...
  def test_variants(self):
    self._registry.register_plugin('', _TestSnippetPlugin(('root0',)))
    self._registry.register_plugin('', _TestSnippetPlugin(('root1',)))
    self._registry.register_plugin('foo', _TestSnippetPlugin(('foo0',)))
    self._registry.register_plugin('foo/bar', _TestSnippetPlugin(('bar0',)))
    self.assertSequenceEqual(
        sorted(('root0', 'root1', 'foo0', 'bar0')),
        sorted(self._registry.variants('foo/bar')))
